...
9. Tap the canvas on a touch device, click it with a mouse, and press Space with the page focused. **Expected:** each makes the panda jump about 168 px high and land again; Space does not scroll the page.
...
14. Land on top of a box. **Expected:** the run restarts at score "0".
